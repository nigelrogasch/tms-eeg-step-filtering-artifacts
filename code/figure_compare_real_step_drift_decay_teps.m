...
set(gca,'xlim',[0,length(cleaningVar)+1],'ylim',[0,30],'tickdir','out','box','off','linewidth',1.5,'fontsize',12,...
...
plot([0,0],[-30,30],'k--','linewidth',1.5);

set(gca,'xlim',[-300,300],'ylim',[-30,30],'box','off','tickdir','out','linewidth',1.5,'fontsize',12);
...
print(fig2,'-dpng',[pathFigures,'figure_compare_methods_abs_ground_truth_with_decay']);